...
{
    /// <summary>
    /// AlarmScenarioTargetListView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class AlarmScenarioTargetListView : UserControl
    {
        public AlarmScenarioTargetListView()
        {
            InitializeComponent();
        }

        public AlarmScenarioTargetListView(object dummy)
        {
            InitializeComponent();
        }
