...
{
    /// <summary>
    /// AlarmScenarioPropertiesView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class AlarmScenarioPropertiesView : UserControl
    {
        public AlarmScenarioPropertiesView()
        {
            InitializeComponent();
        }

        public AlarmScenarioPropertiesView(object dummy)
        {
            InitializeComponent();
        }
