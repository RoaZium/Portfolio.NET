...
{
    public class LineChartComponentViewModel : DMViewModelBase
    {
        private LineChartComponentModel _Model;
        public LineChartComponentModel Model
        {
            get { return _Model; }
            set
            {
        ...
        public LineChartComponentViewModel()
        {
        }
        ...
        private async void LoadSensorData()
        {
            try
            {
                ...
                List<DataTable> dts = await DBHelper.GetSensorRealtimeData(Model.TargetCode);
