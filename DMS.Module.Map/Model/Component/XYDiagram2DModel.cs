...
{
    public class XYDiagram2DModel : BaseComponentModel
    {
        public override string Background { get => base.Background; set => base.Background = value; }
        public override string BarDistance { get => base.BarDistance; set => base.BarDistance = value; }
        ...
        public override string DependentAxesYRange { get => base.DependentAxesYRange; set => base.DependentAxesYRange = value; }
        public override string EnableAxisXNavigation { get => base.EnableAxisXNavigation; set => base.EnableAxisXNavigation = value; }
        public override string EnableAxisYNavigation { get => base.EnableAxisYNavigation; set => base.EnableAxisYNavigation = value; }
        public override string EqualBarWidth { get => base.EqualBarWidth; set => base.EqualBarWidth = value; }
        ...
        public override string PaneOrientation { get => base.PaneOrientation; set => base.PaneOrientation = value; }
        public override string Rotated { get => base.Rotated; set => base.Rotated = value; }
