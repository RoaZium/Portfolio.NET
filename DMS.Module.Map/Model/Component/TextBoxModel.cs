...
{
    public class TextBoxModel : BaseComponentModel
    {
        ...
        public override bool? ForegroundAlarmVisibility { get => base.ForegroundAlarmVisibility; set => base.ForegroundAlarmVisibility = value; }
