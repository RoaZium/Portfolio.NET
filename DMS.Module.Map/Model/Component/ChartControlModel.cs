...
{
    public class ChartControlModel : BaseComponentModel
    {
        public override string AnimationMode { get => base.AnimationMode; set => base.AnimationMode = value; }
        public override string AutoLayout { get => base.AutoLayout; set => base.AutoLayout = value; }
