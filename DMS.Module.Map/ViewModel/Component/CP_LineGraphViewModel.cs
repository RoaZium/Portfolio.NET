...
{
    public class CP_LineGraphViewModel : CP_CommonBaseViewModel
    {
        ...
        protected override void OnComponentData()
        {
            if (DmComponentM.PropertyM.CategoryCode == "0")
            {
                ...
                DmComponentM.ChartSeriesList = chartSampleData.SetLineChartData();
            }
            else
            {
        ...
        protected override void OnSubscribeAsyncMqtt(MqttMsgPublishEventArgs e)
        {
            ...
            {
                LogManager.Instance.WriteLine(LOG.LOG, LOG_LEVEL.ErrorLevel, "LineGraph MQTT:" + ex.ToString());
            }
        }
