...
{
    public class CP_ScatterChartViewModel : CP_CommonBaseViewModel
    {
        ...
        protected override void OnComponentData()
        {
            if (DmComponentM.PropertyM.CategoryCode == "0")
            {
                ...
                DmComponentM.ChartSeriesList = chartSampleData.SetScatterChartData();
            }
        }
        ...
        protected override void OnSubscribeAsyncMqtt(MqttMsgPublishEventArgs e)
        {
            ...
            {
                LogManager.Instance.WriteLine(LOG.LOG, LOG_LEVEL.ErrorLevel, "ScatterChart MQTT:" + ex.ToString());
            }
        }
    }
}
