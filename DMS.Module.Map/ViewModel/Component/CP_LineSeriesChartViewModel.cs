...
{
    public class CP_LineSeriesChartViewModel : CP_CommonBaseViewModel
    {
        ...
        protected override void OnComponentData()
        {
            if (DmComponentM.PropertyM.CategoryCode == "0")
            {
                ...
                DmComponentM.ChartSeriesList = chartSampleData.SetLineSeriesChartData();
            }
        }
        ...
        protected override void OnSubscribeAsyncMqtt(MqttMsgPublishEventArgs e)
        {
            ...
            {
                LogManager.Instance.WriteLine(LOG.LOG, LOG_LEVEL.ErrorLevel, "LineSeriesChart MQTT:" + ex.ToString());
            }
        }
    }
}
