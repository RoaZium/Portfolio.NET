...
{
    public class CP_XbarChartViewModel : CP_CommonBaseViewModel
    {
        ...
        protected override void OnComponentData()
        {
            if (DmComponentM.PropertyM.CategoryCode == "0")
            {
                ...
                DmComponentM.ChartSeriesList = chartSampleData.SetXbarChartData();
            }
        }
        ...
        protected override void OnSubscribeAsyncMqtt(MqttMsgPublishEventArgs e)
        {
            ...
            {
                LogManager.Instance.WriteLine(LOG.LOG, LOG_LEVEL.ErrorLevel, "XbarChart MQTT:" + ex.ToString());
            }
        }
    }
}
